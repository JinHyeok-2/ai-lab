...
MAX_USDT       = 15                    # 1회 최대 진입 금액 상한 (USDT) — 잔고 $90 기준 축소
POSITION_PCT   = 10                    # 메인: 잔고의 10% 진입 (예: $90 × 10% = $9)
...
# ── 알트코인 스캐너 설정 ─────────────────────────────────────────────
MAX_USDT_ALT      = 12    # 알트 1회 최대 진입 금액 상한 (USDT) — 잔고 $90 기준 축소
POSITION_PCT_ALT  = 8     # 알트: 잔고의 8% 진입 (예: $90 × 8% = $7.2)
...
ALT_AUTO_CONFIDENCE    = 68   # 자동 주문 발동 최소 신뢰도 (%) (65→68, conf40~60 전패 데이터)
ALT_MANUAL_MIN_CONF    = 55   # 수동 주문 버튼 활성화 최소 신뢰도 (%) (40→55)
