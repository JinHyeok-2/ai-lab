...
BLACKLIST = {'BRUSDT', 'SIRENUSDT', 'XAUUSDT', 'XAGUSDT', 'RIVERUSDT', 'SIGNUSDT', 'PAXGUSDT', 'BSBUSDT'}  # 반복 손실/극단 변동성/TradFi/저유동성(-$9.23)
    ...
    try:
        ...
        for sym in symbols:
            ...
            try:
                ...
                is_signal = near_low and cvd_rising and rsi < 35
